...
class DetectorConstruction : public G4VUserDetectorConstruction
{
  ...
  const G4VPhysicalVolume* GetIcePV() const;
  ...
  G4VPhysicalVolume*   fIcePV;      // the ice physical volume
...
inline const G4VPhysicalVolume* DetectorConstruction::GetIcePV() const  { 
  return fIcePV; 
}
